...
Freud icons is from strange icons sandow icon pack with close to 500 regular icons in solid and
monotone styles.
  ...
  Widget build(BuildContext context) {
    return Card(
      child: Column(
        ...
        children: [
          Icon(FreudSolidIcons.activityCycling),
          const SizedBox(height: 10),
          Text('Solid Activity Cycling')
        ],
      ),
    );
  }
