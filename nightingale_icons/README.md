...
[![pub package](https://img.shields.io/pub/v/sandow_icons.svg?color=success&style=flat-square)](https://pub.dartlang.org/packages/nightingale_icons)
...
Nightingale icons is from strange icons sandow icon pack with close to 500 regular icons in solid
and monotone styles.
...
or `flutter pub add nightingale_icons` from your terminal
  ...
  Widget build(BuildContext context) {
    return Card(
      child: Column(
        ...
        children: [
          Icon(NightingaleSolidIcons.anatomyHeartbeat),
          const SizedBox(height: 10),
          Text('Solid Anatomy Heartbeat')
        ],
      ),
    );
  }
